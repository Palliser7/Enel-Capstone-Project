...
#SSID: 200389010
#Refereence provided in report of where this code was obtained from
#
#
#
...
cv_file = cv2.FileStorage('/home/pi/Desktop/Camera Calibration/calibration.yaml', cv2.FILE_STORAGE_WRITE)
cv_file.write("K", matrix)
cv_file.write("D", distortion)
cv_file.release()
